...
public class PreferencesConverter {
	...
	*/
	...
	public static eu.europa.ec.fisheries.wsdl.user.types.Preferences 
	    convertInformationModelToUserModel(eu.europa.ec.mare.usm.information.domain.Preferences domainPreferences)
	    {
		eu.europa.ec.fisheries.wsdl.user.types.Preferences typesPreferences = 
				new eu.europa.ec.fisheries.wsdl.user.types.Preferences();
		...
		Iterator<eu.europa.ec.mare.usm.information.domain.Preference> iterator = domainPreferencesSet.iterator();
		while(iterator.hasNext())
		{
			eu.europa.ec.mare.usm.information.domain.Preference domainPreferenceElement = iterator.next();
	...
	public static eu.europa.ec.mare.usm.information.domain.Preferences 
		...
		List<eu.europa.ec.fisheries.wsdl.user.types.Preference> typesPreferencesList = typesPreferences.getPreference();
		Iterator<eu.europa.ec.fisheries.wsdl.user.types.Preference> iterator = typesPreferencesList.iterator();
		while(iterator.hasNext())
		{
			eu.europa.ec.fisheries.wsdl.user.types.Preference typesPreferenceElement = iterator.next();
			eu.europa.ec.mare.usm.information.domain.Preference domainPreferenceElement = PreferenceConverter.convertUserModelToInformationModel(typesPreferenceElement);
