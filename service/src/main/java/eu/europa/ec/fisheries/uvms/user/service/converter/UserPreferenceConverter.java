...
public class UserPreferenceConverter {
    ...
    public static eu.europa.ec.fisheries.wsdl.user.types.UserPreference convertInformationModelToUserModel(eu.europa.ec.mare.usm.information.domain.UserPreference domainUserPreference) {
        if (domainUserPreference == null) {
            return null;
        }
        eu.europa.ec.fisheries.wsdl.user.types.UserPreference typesUserPreference = new eu.europa.ec.fisheries.wsdl.user.types.UserPreference();
    ...
    public static eu.europa.ec.mare.usm.information.domain.UserPreference convertUserModelToInformationModel(eu.europa.ec.fisheries.wsdl.user.types.UserPreference typesUserPreference) {
        eu.europa.ec.mare.usm.information.domain.UserPreference domainUserPreference = new eu.europa.ec.mare.usm.information.domain.UserPreference();
