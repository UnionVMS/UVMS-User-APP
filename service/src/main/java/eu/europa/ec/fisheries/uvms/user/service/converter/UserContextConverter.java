...
public class UserContextConverter {
    ...
    public static eu.europa.ec.fisheries.wsdl.user.types.UserContext convertInformationModelToUserModel(eu.europa.ec.mare.usm.information.domain.UserContext domainUserContext) {
        if (domainUserContext == null) {
            return null;
        }
        eu.europa.ec.fisheries.wsdl.user.types.UserContext typesUserContext = new eu.europa.ec.fisheries.wsdl.user.types.UserContext();
    ...
    convertUserModelToInformationModel(eu.europa.ec.fisheries.wsdl.user.types.UserContext typesUserContext) {
        eu.europa.ec.mare.usm.information.domain.UserContext domainUserContext = new eu.europa.ec.mare.usm.information.domain.UserContext();
