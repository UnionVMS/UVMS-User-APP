...
public class DatasetConverter {
	...
	public static eu.europa.ec.fisheries.wsdl.user.types.Dataset
	    ...
	    {
		eu.europa.ec.fisheries.wsdl.user.types.Dataset typesDataset = 
				new eu.europa.ec.fisheries.wsdl.user.types.Dataset();
	...
	public static eu.europa.ec.mare.usm.information.domain.DataSet 
	   ...
	   {
		eu.europa.ec.mare.usm.information.domain.DataSet domainDataset = 
				new eu.europa.ec.mare.usm.information.domain.DataSet();
	...
	public static eu.europa.ec.mare.usm.information.domain.deployment.Dataset 
	   ...
	   {
		eu.europa.ec.mare.usm.information.domain.deployment.Dataset deploymentDataset = 
				new eu.europa.ec.mare.usm.information.domain.deployment.Dataset();
	...
	public static eu.europa.ec.mare.usm.information.domain.DataSetFilter 
	   ...
	   {
		eu.europa.ec.mare.usm.information.domain.DataSetFilter domainDatasetFilter = 
				new eu.europa.ec.mare.usm.information.domain.DataSetFilter();
	...
	convertInformationModelToUserModel(List<eu.europa.ec.mare.usm.information.domain.DataSet> domainDatasetList){
		...
		{
			//List<DatasetExtension> retrievedDatasetList=new ArrayList<DatasetExtension>();
	...
	convertInformationModelToUserModel(eu.europa.ec.mare.usm.information.domain.DataSet datasetModel){
		...
		eu.europa.ec.fisheries.wsdl.user.types.DatasetExtension datasetUserType= new
				eu.europa.ec.fisheries.wsdl.user.types.DatasetExtension();
