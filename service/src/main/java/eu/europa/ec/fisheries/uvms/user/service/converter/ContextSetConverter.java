...
public class ContextSetConverter {
	...
	*/
	...
	public static eu.europa.ec.fisheries.wsdl.user.types.ContextSet 
	    ...
	    {
		eu.europa.ec.fisheries.wsdl.user.types.ContextSet typesContextSet = 
				new eu.europa.ec.fisheries.wsdl.user.types.ContextSet();
		
		Iterator<eu.europa.ec.mare.usm.information.domain.Context> iterator = 
				domainContextSet.getContexts().iterator();
		while(iterator.hasNext())
		{
			eu.europa.ec.mare.usm.information.domain.Context domainContextElement = iterator.next();
	...
	public static eu.europa.ec.mare.usm.information.domain.ContextSet 
	   ...
	   {
		eu.europa.ec.mare.usm.information.domain.ContextSet domainContextSet = 
				new eu.europa.ec.mare.usm.information.domain.ContextSet();		
		...
		Iterator<eu.europa.ec.fisheries.wsdl.user.types.Context> iterator = typesContexts.iterator();
		while(iterator.hasNext())
		{
			eu.europa.ec.fisheries.wsdl.user.types.Context typesContextElement = iterator.next();
			eu.europa.ec.mare.usm.information.domain.Context domainContextElement = ContextConverter.convertUserModelToInformationModel(typesContextElement);
