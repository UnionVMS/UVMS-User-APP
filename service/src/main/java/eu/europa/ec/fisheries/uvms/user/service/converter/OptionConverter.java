...
public class OptionConverter {
    ...
    convertInformationModelToUserModel(eu.europa.ec.mare.usm.information.domain.deployment.Option deploymentOption) {
        eu.europa.ec.fisheries.wsdl.user.types.Option typesOption = new eu.europa.ec.fisheries.wsdl.user.types.Option();
    ...
    convertUserModelToInformationModel(eu.europa.ec.fisheries.wsdl.user.types.Option typesOption) {
        eu.europa.ec.mare.usm.information.domain.deployment.Option deploymentOption = new eu.europa.ec.mare.usm.information.domain.deployment.Option();
