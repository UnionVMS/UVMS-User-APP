...
public class UserEventServiceBean implements UserEventService {
    ...
    @EJB
    UserMessageProducer messageProducer;    
    ...
    public void findOrganisations(@Observes @FindOrganizationsEvent EventMessage message) {        
        ...
        try {
            ...
            FindOrganisationsRequest request = JAXBMarshaller.unmarshallTextMessage(message.getJmsMessage(), 
    ...
    public void ping(@Observes @PingEvent EventMessage message) {
        try {
            ...
            messageProducer.sendMessageBackToRecipient(message.getJmsMessage(), JAXBMarshaller
            		.marshallJaxBObjectToString(pingResponse));
        }
        catch (ModelMarshallException | UserMessageException ex) {
	        ...
	        try {
	            ...
	            try {
	                ...
	                if (e.getCause() != null && e.getCause() instanceof IllegalArgumentException) {
	                    ...
	                    responseString = UserModuleResponseMapper.mapToUserFault(cause, 
	                    		UserModuleMethod.PUT_PREFERENCE);
	                } else {
	                    throw e;
	                }
	            }           	
