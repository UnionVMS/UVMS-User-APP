...
public class ContextConverter {
	...
	public static eu.europa.ec.fisheries.wsdl.user.types.Context
	  ...
	  {
		eu.europa.ec.fisheries.wsdl.user.types.Context typesContext = 
				new eu.europa.ec.fisheries.wsdl.user.types.Context();
	...
	public static eu.europa.ec.mare.usm.information.domain.Context 
	   ...
	   {
		eu.europa.ec.mare.usm.information.domain.Context domainContext = 
				new eu.europa.ec.mare.usm.information.domain.Context();
