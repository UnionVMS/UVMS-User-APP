...
public class RoleConverter {
    ...
    convertInformationModelToUserModel(eu.europa.ec.mare.usm.information.domain.Role domainRole) {
        eu.europa.ec.fisheries.wsdl.user.types.Role typesRole = new eu.europa.ec.fisheries.wsdl.user.types.Role();
        ...
        Set<eu.europa.ec.mare.usm.information.domain.Feature> domainFeatures = domainRole.getFeatures();
        for (Feature domainFeatureElement : domainFeatures) {
            eu.europa.ec.fisheries.wsdl.user.types.Feature typesFeatureElement = FeatureConverter.convertDomainInformationModelToUserModel(domainFeatureElement);
    ...
    convertUserModelToInformationService(eu.europa.ec.fisheries.wsdl.user.types.Role typesRole) {
        eu.europa.ec.mare.usm.information.domain.Role domainRole = new eu.europa.ec.mare.usm.information.domain.Role();
        ...
        List<eu.europa.ec.fisheries.wsdl.user.types.Feature> typesFeatures = typesRole.getFeature();
