...
public class ScopeConverter {
     ...
     */
    public static eu.europa.ec.fisheries.wsdl.user.types.Scope convertInformationModelToUserModel(eu.europa.ec.mare.usm.information.domain.Scope domainScope) {
        eu.europa.ec.fisheries.wsdl.user.types.Scope typesScope = new eu.europa.ec.fisheries.wsdl.user.types.Scope();
        ...
        Set<eu.europa.ec.mare.usm.information.domain.DataSet> domainDatasets = domainScope.getDatasets();
    ...
    convertUserModelToInformationModel(eu.europa.ec.fisheries.wsdl.user.types.Scope typesScope) {
        eu.europa.ec.mare.usm.information.domain.Scope domainScope = new eu.europa.ec.mare.usm.information.domain.Scope();
        ...
        List<eu.europa.ec.fisheries.wsdl.user.types.Dataset> typesDatasets = typesScope.getDataset();
